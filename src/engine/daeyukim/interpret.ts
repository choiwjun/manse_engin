...
const GWA_MYEONG_TEXT: Record<string, string> = {
  ...
  '지일과': '여러 갈래 중 하나를 택해야 하는 과. 일간과 기운이 같은 쪽을 따르면 순리다.',
  '섭해과': '이해가 깊게 얽힌 과. 어느 쪽도 쉽게 정해지지 않으니 신중한 판단이 필요하다.',
  '호시과': '밖에서 화살이 날아오는 과. 멀리서 오는 부담이나 변고에 대비해야 한다.',
  '탄사과': '내가 멀리 겨누는 과. 힘이 미치기 어려우니 큰 기대보다 겸손한 대처가 좋다.',
};
