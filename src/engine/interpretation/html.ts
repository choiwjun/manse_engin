...
${report.context?.yongsinSchoolSpread ? `    <li><span class="lbl">학파별 용신</span> ${esc(report.context.yongsinSchoolSpread)}${report.context.yongsinConsensus ? ` (${esc(report.context.yongsinConsensus)})` : ''}</li>` : ''}
